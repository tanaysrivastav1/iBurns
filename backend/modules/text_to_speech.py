...
TEMPLATE_MAP = {
    "birth": "{pronoun_1} {last_name} was born on {date} in {location}. ",
    "childhood": "{pronoun_1} {last_name} spent most of {pronoun_3} childhood in {location} between {start_year} to {end_year} speaking Greek.",
