...
with open("./modules/major_events.json", "r", encoding="utf-8") as json_file:
    major_events = json.load(json_file)
with open("./modules/switches.json", "r", encoding="utf-8") as json_file:
    switches = json.load(json_file)
with open("./modules/landmarks.json", "r", encoding="utf-8") as json_file:
